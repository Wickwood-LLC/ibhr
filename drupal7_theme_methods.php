...
function ibhr_process_html(&$variables) {
...
function ibhr_breadcrumb($variables) {
 ...
 * @ingroup themeable
 */
function ibhr_button($variables) {
 ...
 */
function ibhr_preprocess_page(&$vars) {
 ...
 * @ingroup themeable
 */
function ibhr_menu_local_task($variables) {
  ...
  return '<li>' .
	  '<span class="art-button-wrapper' . $active_class. '">'.
	  '<span class="art-button-l"></span>'.
      '<span class="art-button-r"></span>'.
 ...
 */
function ibhr_feed_icon($variables) {
 ...
 * @ingroup themeable
 */
function ibhr_node_preview($variables) {
  $node = $variables['node'];
