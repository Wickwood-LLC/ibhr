...
function ibhr_menu_local_task($link, $active = FALSE) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   A descriptive title of the feed.
  */
function ibhr_feed_icon($url, $title) {
 ...
 */
function ibhr_preprocess_comment_wrapper(&$vars) {
 ...
 */
function ibhr_breadcrumb($breadcrumb) {
  if (!empty($breadcrumb)) {
    return '<div class="breadcrumb art-postcontent">'. implode(' | ', $breadcrumb) .'</div>';
  }
}

function ibhr_service_links_node_format($links) {
...
*/
function ibhr_img_assist_page($content, $attributes = NULL) {
 ...
 * @ingroup themeable
 */
function ibhr_node_preview($node) {
